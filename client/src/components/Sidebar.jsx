...
const Sidebar = () => {
  ...
  // ✅ Get user from global context (NO API CALL HERE)
  ...
  return (
    <>
      ...
      {/* ================= SIDEBAR ================= */}
      <aside
        className={`fixed top-16 left-0 h-[calc(100vh-64px)] w-64 bg-[#0f0f0f] border-r border-gray-800 text-white flex flex-col justify-between transition-transform duration-300 z-40
            ...
            <p className="text-xs text-green-400 flex items-center gap-1">
              <span
                className={`w-2 h-2 rounded-full ${
                  userData?.isOnline ? "bg-green-400" : "bg-gray-500"
                }`}
              ></span>
              Online
            </p>
